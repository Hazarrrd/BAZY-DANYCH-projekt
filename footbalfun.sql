...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2018 at 02:16 AM
...
DECLARE powtorka varchar(50);
        ...
        IF powtorka IS NOT null THEN 
	SELECT  zespoly.nazwa, stadiony.nazwa FROM stadiony JOIN zespoly ON stadiony.ID=zespoly.stadion WHERE stadiony.nazwa=arena;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `informacjeOZespole` (IN `klub` VARCHAR(50))  BEGIN
	DECLARE powtorka varchar(50);
        ...
        IF powtorka IS NOT null THEN 
	SELECT  zespoly.nazwa, zespoly.mijescowosc, zespoly.liga, zespoly.trener, zespoly.barwy, stadiony.nazwa, stadiony.adres, stadiony.ilosc_miejsc FROM stadiony JOIN zespoly ON stadiony.ID=zespoly.stadion WHERE zespoly.nazwa=klub;
...
--
-- Table structure for table `ekstraklasa`
--
...
--
-- Dumping data for table `ekstraklasa`
--
...
--
-- Table structure for table `la_liga`
--
...
--
-- Dumping data for table `la_liga`
--
...
--
-- Table structure for table `ligue_1`
--
...
--
-- Dumping data for table `ligue_1`
--
...
--
-- Table structure for table `mecze_abstrakcyjne`
--
...
--
-- Stand-in structure for view `podv_mecze`
...
--
-- Stand-in structure for view `podv_mecze_abstrakcyjne`
-- (See below for the actual view)
--
...
--
-- Table structure for table `premier_leauge`
--
...
--
-- Dumping data for table `premier_leauge`
--
...
--
-- Table structure for table `serie_a`
--
...
--
-- Dumping data for table `serie_a`
--
...
--
-- Table structure for table `stadiony`
--
...
--
-- Dumping data for table `stadiony`
--
...
--
-- Table structure for table `test_leauge`
--
...
--
-- Dumping data for table `test_leauge`
--
...
--
-- Stand-in structure for view `v_bundesliga`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_ekstraklasa`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_la_liga`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_ligue_1`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_mecze`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_mecze_abstrakcyjne`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_premier_leauge`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_serie_a`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `v_test_leauge`
-- (See below for the actual view)
--
...
--
-- Structure for view `podv_mecze_abstrakcyjne`
--
...
--
-- Structure for view `v_bundesliga`
--
...
--
-- Structure for view `v_ekstraklasa`
--
...
--
-- Structure for view `v_mecze_abstrakcyjne`
--
...
--
-- Structure for view `v_premier_leauge`
--
...
--
-- Structure for view `v_test_leauge`
--
...
--
ALTER TABLE `mecze`
  MODIFY `id_meczy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `mecze_abstrakcyjne`
--
ALTER TABLE `mecze_abstrakcyjne`
  MODIFY `id_meczy` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `premier_leauge`
--
ALTER TABLE `premier_leauge`
  MODIFY `ID_zespolu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `serie_a`
--
ALTER TABLE `serie_a`
  MODIFY `ID_zespolu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT for table `stadiony`
--
ALTER TABLE `stadiony`
...
--
-- Constraints for table `mecze_abstrakcyjne`
--
ALTER TABLE `mecze_abstrakcyjne`
